...
import {
    Search, Filter, LogOut, Plus, Trash2, CheckCircle,
    Calendar, List, ChevronDown, MoreVertical, Edit,
    Clock, AlertCircle, User, Bell, Target, X, Menu
} from 'lucide-react';
import { format } from 'date-fns';
import CalendarView from '../components/CalendarView';
...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-50">
                ...
                <div className="flex items-center justify-between max-w-7xl mx-auto">
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 className="text-lg font-semibold text-gray-900">Taskly</h1>
                                <p className="text-gray-500 text-xs">Dashboard</p>
                            </div>
                        </div>
                    </div>

                    {/* Desktop User Info & Actions - Like the screenshot */}
                    <div className="hidden md:flex items-center space-x-4">
                        <div className="flex items-center space-x-3">
                            <div className="text-right">
                                <p className="text-sm font-medium text-gray-900">{user?.name || 'SUMIT DIWAKAR'}</p>
                                <p className="text-xs text-gray-500">{user?.email || 'sumitdiwakar476@gmail.com'}</p>
                            </div>
                            <div className="w-9 h-9 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                        ...
                        <button
                            onClick={logout}
                            className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-colors text-sm shadow-sm"
                        >
                    ...
                    <div className="md:hidden">
                        <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white text-xs font-medium">
                            {user?.name?.charAt(0) || 'S'}
                        </div>
                    </div>
                </div>
            ...
            {/* Mobile Menu Sidebar */}
            <div className={`
                fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 shadow-xl 
            ...
            `}>
                <div className="p-5 border-b border-gray-200">
                    <div className="flex items-center space-x-3 mb-5">
                        ...
                        <div>
                            <p className="font-medium text-gray-900">{user?.name || 'SUMIT DIWAKAR'}</p>
                            <p className="text-sm text-gray-500">{user?.email || 'sumitdiwakar476@gmail.com'}</p>
                        </div>
                    </div>
            ...
            <div className="p-5 max-w-7xl mx-auto">
                {/* Welcome Section - Like the screenshot */}
                <div className="mb-8">
                    <h2 className="text-xl font-semibold text-gray-900 mb-1">
                        Welcome back, <span className="text-blue-600">{user?.name || 'SUMIT DIWAKAR'}!</span>
                    </h2>
                    <p className="text-gray-600 text-sm">Here's your task overview for today.</p>
                </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-900 mt-2">{total}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-900 mt-2">{completed}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-900 mt-2">{inProgress}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xl font-bold text-gray-900 mt-2">{percentage}%</p>
                            </div>
                ...
                {/* Main Content Area - Like the screenshot */}
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    {/* Toolbar - Like the screenshot */}
                    <div className="p-5 border-b border-gray-200">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full md:w-auto">
                                <div className="relative w-full sm:w-56">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search tasks..."
                                        className="pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none w-full text-gray-900 placeholder-gray-500 text-sm"
                                        value={searchTerm}
                                        onChange={(e) => setSearchTerm(e.target.value)}
                                    />
                                </div>
                            ...
                            {/* View buttons - Like the screenshot */}
                            <div className="flex items-center space-x-2 w-full sm:w-auto">
                                <button
                                    onClick={() => setView('list')}
                                    className={`px-4 py-2.5 rounded-lg flex items-center justify-center space-x-2 text-sm shadow-sm w-full sm:w-auto
                                        ${view === 'list'
                                            ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white'
                    ...
                    {/* Add Task Form - Like the screenshot */}
                    <form onSubmit={addTask} className="p-5 border-b border-gray-200">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
                                ...
                                <div className="relative w-full md:w-48">
                                    <div className="relative">
                                        <input
                                            type="date"
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white outline-none text-sm text-gray-900 appearance-none"
                                            value={newTask.dueDate}
                                            onChange={(e) => setNewTask({ ...newTask, dueDate: e.target.value })}
                                            disabled={isAddingTask}
                                        ...
                                        {/* Custom placeholder */}
                                        {!newTask.dueDate && (
                                            <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none text-sm">
                                                dd-mm-yyyy
                                            </div>
                                        )}
                                        {/* Clear button */}
                                ...
                                <select
                                    className="w-full md:w-40 px-4 py-3 border border-gray-300 rounded-lg bg-white outline-none text-sm text-gray-900"
                                    value={newTask.status}
                                    onChange={(e) => setNewTask({ ...newTask, status: e.target.value })}
                                    disabled={isAddingTask}
                                >
                                ...
                                <button
                                    type="submit"
                                    disabled={isAddingTask}
                                    className="w-full md:w-auto px-5 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-sm shadow-sm"
                                >
                                    {isAddingTask ? (
                                        <>
                                            <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                    ...
                    {/* Tasks List View - Like the screenshot */}
                    {view === 'list' ? (
                        <div className="p-5">
                            ...
                            {filteredTasks.length === 0 ? (
                                <div className="text-center py-10">
                                    ...
                                    <h4 className="text-gray-900 font-medium text-base mb-1">No tasks found</h4>
                                ...
                                <div className="space-y-4">
                                    {filteredTasks.map((task) => (
                                        <div
                                            key={task._id}
                                            className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-sm transition-all duration-200 hover:border-blue-200"
                                        >
                                            <div className="flex items-start justify-between">
                                                <div className="flex items-start flex-1 min-w-0 mr-4">
                                                    ...
                                                    <div className="ml-4 flex-1 min-w-0">
                                                        <h4 className={`font-medium text-gray-900 text-sm mb-2 ${task.status === 'Completed' ? 'line-through text-gray-500' : ''}`}>
                                                            {task.title}
                                                        </h4>
                                                        <div className="flex flex-wrap items-center gap-2">
                                                            <span className={`inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-full text-xs font-medium border ${getStatusColor(task.status)}`}>
                                                                {getStatusIcon(task.status)}
                                                                <span>{task.status}</span>
                                                            </span>
                                                            {task.dueDate && (
                                                                <span className="text-xs text-gray-500 flex items-center bg-gray-50 px-3 py-1.5 rounded">
                                                    ...
                                                    {activeTaskMenu === task._id && (
                                                        <div className="absolute right-0 top-full mt-1 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                                                            <button 
                                                                ...
                                                                className="w-full px-4 py-3 text-left flex items-center space-x-3 text-sm text-blue-600 hover:bg-blue-50 hover:text-blue-700 border-b border-gray-100"
                                                            >
                                                            ...
                                                            <button 
                                                                ...
                                                                className="w-full px-4 py-3 text-left flex items-center space-x-3 text-sm text-red-600 hover:bg-red-50 hover:text-red-700"
                                                            >
